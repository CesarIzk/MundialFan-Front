...
function getAvatarUrl(user) {
  ...
  if (user.profile_picture) {
    return `https://mundialfan-api.railway.internal/uploads/${user.profile_picture}`;
  }
  ...
  if (post.media_path && post.media_path !== 'null' && post.media_path !== '') {
    ...
    if (!mediaUrl.startsWith('http')) {
      ...
      if (mediaUrl.startsWith('uploads/')) {
        mediaUrl = `https://mundialfan-api.railway.internal/${mediaUrl}`;
      } else {
        mediaUrl = `https://mundialfan-api.railway.internal/uploads/${mediaUrl}`;
      }
    }

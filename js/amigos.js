...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  try {
    ...
    myFriends = apiFriends.map(u => ({
      ...
      mutualFriends: 0,
      avatar: u.profile_picture ? `https://mundialfan-api.railway.internal/uploads/${u.profile_picture}` : "../images/default-profile.jpg",
      cover: u.cover_picture    ? `https://mundialfan-api.railway.internal/uploads/${u.cover_picture}`   : `https://picsum.photos/seed/${u.id}/400/120`
    }));
  } catch (error) {
